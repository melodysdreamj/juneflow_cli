...
class Module {
  ...
  String toString() {
    return jsonEncode({
      ...
      'PubspecCodeBloc': jsonEncode(PubspecCodeBloc.map((model) => model.toString()).toList()),
  ...
  static Module fromString(String jsonString) {
    ...
    obj.LibraryName = data['LibraryName'] ?? "";
    obj.LibraryVersion = data['LibraryVersion'] ?? "";
    obj.ReadMeContents = data['ReadMeContents'] ?? "";
    // obj.S003 = data['S003'] ?? "";
    // obj.S004 = data['S004'] ?? "";
    // obj.S005 = data['S005'] ?? "";
    // obj.S006 = data['S006'] ?? "";
    ...
    obj.PubspecCodeBloc = List<String>.from(data['PubspecCodeBloc'] is String ? jsonDecode(data['PubspecCodeBloc']) : (data['PubspecCodeBloc'] ?? [])).map((item) => PubspecCode.fromString(item)).toList();
